...
// [[Rcpp::export]]
Rcpp::List sparseSCAcpp_rand_start(arma::mat X, int Q, double RIDGE, arma::vec LASSO, 
                       arma::mat fixW, arma::mat Wstart, int maxItrOuterloop, int nStarts,
